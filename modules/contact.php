...
<section class="contact-form-style1-area">
    <div class="container">
        <div class="sec-title text-center">
            <div class="sub-title">
                <h3>¡Haznos saber tu estilo de diseño preferido!</h3>
            </div>
                ...
                <div class="contact-form-outer-box">
                    ...
                    <div class="contact-inner-box">
                        ...
                        <div class="contact-form">
                            <form id="" name="" class="" action="" method="post">
                                <div class="row">
                                    <div class="col-xl-6">
                                        <div class="input-box">
                                    ...
                                    <div class="col-xl-6">
                                        <div class="input-box">
                                            <textarea name="msj" placeholder="Escribe tu mensaje"
                                                required=""></textarea>
                                        </div>
