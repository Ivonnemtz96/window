            ...
            <div class="row pdb-65">
                ...
                <div class="col-xl-2 col-lg-6">
                    <div class="widget footer-widget">
                        ...
                        <ul class="footer-widget-list">
                            ...
                            <li>
                                <a href="service-interior-work.html">Interior Work</a>
                            </li>
                            <li>
                ...
                <div class="col-xl-3 col-lg-6">
                    <div class="widget footer-widget mrr-30 mrr-md-0">
                        ...
                        <address class="mrb-0">
                            ...
                            <div class="mrb-10">
                                <a href="#"><i class="fas fa-phone-alt mrr-10"></i>+088 234 432
                                    15565</a>
                            </div>
                            <div class="mrb-10">
                ...
                <div class="col-xl-3 col-lg-6">
                    <div class="widget footer-widget mrr-60 mrr-md-0">
                        ...
                        <p class="mrb-25">
                            There are many vari of pass but majority have suffered some
                            injected of a humour
                        </p>
            ...
            <div class="row pdt-30 pdb-30 footer-copyright-area">
                <div class="col-xl-12">
                    <div class="text-center">
                        <span>Copyright by WebexTheme © 2023. All rights reserved
                        </span>
                    </div>
                </div>
            </div>
